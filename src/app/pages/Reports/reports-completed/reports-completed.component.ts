...
@Component({
  selector: 'app-reports-completed',
  templateUrl: './reports-completed.component.html',
  styleUrls: ['./reports-completed.component.css']
})
export class ReportsCompletedComponent implements OnInit {
  // Raw Data
  excelData: any[] = [];
