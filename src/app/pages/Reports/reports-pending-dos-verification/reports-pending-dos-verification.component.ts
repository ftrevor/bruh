...
@Component({
  selector: 'app-reports-pending-dos-verification',
  templateUrl: './reports-pending-dos-verification.component.html',
  styleUrls: ['./reports-pending-dos-verification.component.css']
})
export class ReportsPendingDosVerificationComponent implements OnInit {
  // Raw Data
  excelData: any[] = [];
