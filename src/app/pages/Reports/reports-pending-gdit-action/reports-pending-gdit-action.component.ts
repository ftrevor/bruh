...
@Component({
  selector: 'app-reports-pending-gdit-action',
  templateUrl: './reports-pending-gdit-action.component.html',
  styleUrls: ['./reports-pending-gdit-action.component.css']
})
export class ReportsPendingGditActionComponent implements OnInit {
  // Raw Data
  excelData: any[] = [];
